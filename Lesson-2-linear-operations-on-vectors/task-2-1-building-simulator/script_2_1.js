...
const createTaskVect=()=>{
    ...
    condition.innerHTML = `<h2>Задание 2.1. Сумма и разность векторов</h2><p>Постройте ${task[variant]}</p><section class="section-progress"><progress value="0" max="10"></progress><p>Задание №${progressValue + 1} / ${data.numberOfTask}</section>`;
